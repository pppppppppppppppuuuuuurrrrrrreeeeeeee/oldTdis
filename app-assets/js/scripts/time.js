...
$(document).ready(function() {
    ...
    // The timeSpinner widget demo
    $('#THE_TIME').timeSpinner();
    $('#CREATE').hide();

    // Use AM/PM button
    $('#ENABLE_AMPM').on('click', function(event) {
        $('#THE_TIME').timeSpinner('option', 'ampm', true);
        return false;
    });

    // Use 24-hour format button
    $('#DISABLE_AMPM').on('click', function(event) {
        $('#THE_TIME').timeSpinner('option', 'ampm', false);
        return false;
    });

    $('#SET_TO_MIDNIGHT').on('click', function(event) {
        $('#THE_TIME').timeSpinner('value', '00:00');
    });

    $('#SET_TO_1345').on('click', function(event) {
        $('#THE_TIME').timeSpinner('value', '13:45');
    });

    $('#GET_TIME').on('click', function(event) {
        alert($('#THE_TIME').timeSpinner('value'));
    });
    ...
    $('#DESTROY').on('click', function (event) {
        $('#THE_TIME').timeSpinner('destroy');
        $(this).hide();
        $('#CREATE').show();
    });

    $('#ENABLE').on('click', function (event) {
        $('#THE_TIME').timeSpinner('enable');
    });

    $('#DISABLE').on('click', function (event) {
        $('#THE_TIME').timeSpinner('disable');
    });

    $('#SIZE_10PT').on('click', function (event) {
        $('#THE_TIME').timeSpinner('instance').$container.css('font-size', '10pt');
    });

    $('#SIZE_1EM').on('click', function (event) {
        $('#THE_TIME').timeSpinner('instance').$container.css('font-size', '1em');
    });
